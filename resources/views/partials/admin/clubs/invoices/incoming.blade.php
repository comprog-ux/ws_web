<div class="panel panel-default" ng-if="clubs.club.invoices_incoming.length">
    ...
    <div class="table-responsive">
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                <tr ng-repeat="invoice in clubs.club.invoices_incoming">
...
<div class="panel panel-default" ng-if="!clubs.club.invoices_incoming.length">
    ...
    <div class="panel-body">
        ...
        <hr>
        <button ui-sref="admin.clubs.invoices.index({id: clubs.club.id})" class="btn btn-primary">{{_('Fakturaöversikt')}}</button>
    </div>
</div>