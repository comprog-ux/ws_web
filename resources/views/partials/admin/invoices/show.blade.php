<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-xs-6">
                <h4>{{_('Avsändare')}}</h4>
                <a ng-if="invoices.invoice.sender_object == 'club'" ui-sref="admin.clubs.show({id: invoices.invoice.sender.id})"><h3 class="margin-0"><% invoices.invoice.sender_name %></h3></a>
                <a ng-if="invoices.invoice.sender_object == 'user'" ui-sref="admin.users.show({user_id: invoices.invoice.sender.user_id})"><h3 class="margin-0"><% invoices.invoice.sender_name %></h3></a>
                <a ng-if="invoices.invoice.sender_object == 'district'" ui-sref="admin.districts.show({id: invoices.invoice.sender.id})"><h3 class="margin-0"><% invoices.invoice.sender_name %></h3></a>
                <div class="break-lines"><% invoices.invoice.sender_address_combined %></div>
            </div>
            <div class="col-xs-6">
                <h4>{{_('Mottagare')}}</h4>
                <a ng-if="invoices.invoice.recipient_object == 'club'" ui-sref="admin.clubs.show({id: invoices.invoice.recipient.id})"><h3 class="margin-0"><% invoices.invoice.recipient_name %></h3></a>
                <a ng-if="invoices.invoice.recipient_object == 'user'" ui-sref="admin.users.show({user_id: invoices.invoice.recipient.user_id})"><h3 class="margin-0"><% invoices.invoice.recipient_name %></h3></a>
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-4">
                <div class="row">
                    <div class="col-xs-6">
                        <label>{{_('Skapat av')}}</label><br>
                    </div>
                    <div class="col-xs-6 text-right">
                        <a ui-sref="admin.users.show({user_id: invoices.invoice.user.user_id})"><% invoices.invoice.user.fullname %></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
...
<div class="panel panel-default" ng-if="invoices.invoice.signups.length">
    ...
    <div class="table-responsive">
        <table class="table table-hover table-bordered">
            ...
            <tr ng-repeat="signup in invoices.invoice.signups">
                ...
                <td><a ui-sref="competition.clubsignups({id: signup.competitions_id})"><% signup.competition.name %></a></td>
...
<div class="panel panel-default" ng-if="invoices.invoice.teams.length">
    <div class="panel-heading">
        <div class="row">
    ...
    <div class="table-responsive">
        <table class="table table-hover table-bordered">
            ...
            <tr ng-repeat="team in invoices.invoice.teams">
                ...
                <td><a ui-sref="competition.clubsignups({id: team.competitions_id})"><% team.competition.name %></a></td>
