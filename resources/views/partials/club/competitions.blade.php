        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-sm-6">{{_('Tävlingar')}}</div>
                        <div class="col-sm-6 text-right"><% competitions.competitions.total %> st</div>
                    </div>
                </div>
                ...
                <div class="table-responsive" ng-if="competitions.competitions.total">
                    <table class="table table-hover table-bordered table-striped ">
                        ...
                        <tbody>
                            <tr ui-sref="competition.show({id: competition.id, view: 'information'})" ng-repeat="competition in competitions.competitions.data">
                                ...
                                <td><span ng-repeat="weaponclass in competition.weaponclasses" class="label label-default margin-right-5 inline-block"><% (competition.championships_id) ? weaponclass.classname_general : weaponclass.classname %></span></td>
                                <td>
