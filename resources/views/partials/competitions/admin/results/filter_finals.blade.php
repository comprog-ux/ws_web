    ...
    <div class="col-sm-3">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row form-group" ng-if="results.filter.patrol_type != 'finals'">
                    <div class="col-lg-6">
