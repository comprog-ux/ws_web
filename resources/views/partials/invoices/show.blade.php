    ...
    <div class="table-responsive">
        <table class="table table-hover table-bordered">
            ...
            <tr ng-repeat="signup in invoices.invoice.signups">
                ...
                <td><a ui-sref="competitions({id: signup.competition.id})"><% signup.competition.date %> <% signup.competition.name %></a></td>
                ...
                <td><a ui-sref="signup({id: signup.id})">{{_('Visa anmälan')}}</a></td>
            </tr>
            </tbody>
        </table>
    </div>
